...
/**
 * Batch create test users via REST API.
 *
...
public class BatchUserCreator {
    ...
    private static final String REFERENCE_ROLE_CODE = "business";   // 参考角色标识（业务发起）
    private static final String NEW_ROLE_NAME = "test_maker";       // 新角色名称
    private static final String NEW_ROLE_CODE = "test_maker";       // 新角色标识
    private static final int NEW_ROLE_SORT = 99;                    // 新角色排序

    private static final String REFERENCE_USERNAME = "test001";     // 参考用户（获取部门/岗位）
    private static final String USER_PREFIX = "t";                  // 用户名前缀
    ...
    private void run() throws Exception {
        ...
        // Step 2: Find reference role "业务发起" (code=business)
        ...
        // Step 5: Find reference user test001
        ...
        // Step 6: Create new role test_maker
    ...
    private long createRole() throws Exception {
        ...
        body.put("remark", "Auto-created for load testing");
